<div class="wrap">
    ...
    <h3 class="nav-tab-wrapper">
        ...
        <a href="edit.php?post_type=ticket&page=wpticket-settings&tab=<?php echo $id; ?>" class="nav-tab <?php if($id == $current_tab): ?>nav-tab-active<?php endif; ?>"><?php echo $tab['title']; ?></a>
        <?php endforeach; ?>
    </h3>
